<template>
  <div
    class="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 m-auto border border-b-blue-500"
  >
    <div
      class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8"
    >
      <div
        class="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-xs"
      >
      ...
      <div class="w-full border border-amber-200">
        <div class="m-auto">
          <div
            class="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-xs"
          >
